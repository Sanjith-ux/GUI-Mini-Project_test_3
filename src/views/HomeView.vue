<template>
  <section class="space-y-8 animate-fadeIn">
    <div class="rounded-3xl bg-gradient-to-r from-white via-slate-50 to-brand-100/70 p-6 shadow-soft transition-colors duration-300 sm:p-8 dark:from-slate-900 dark:via-slate-900 dark:to-brand-900/60">
      <p class="text-sm uppercase tracking-widest text-brand-600 dark:text-brand-200">New arrivals</p>
      <h1 class="mt-3 font-display text-2xl text-slate-900 dark:text-white sm:text-4xl">
